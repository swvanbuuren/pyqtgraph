...
class GLSurfacePlotItem(GLMeshItem):
    ...
    **Bases:** :class:`GLMeshItem <pyqtgraph.opengl.GLMeshItem>`
    ...
    def __init__(self, x=None, y=None, z=None, colors=None, parentItem=None, **kwds):
        ...
        self.lineWidth = 1.0
        self.lineAntialias = True
        self._vertexes = None
        self._meshdata = MeshData()
        self._grid_lines = []
        surface_options = {**kwds, 'glOptions': self.gl_surface_options}
        super().__init__(parentItem=parentItem, meshdata=self._meshdata, **surface_options)
        
        self.setData(x, y, z, colors, **kwds)
        
        
        
    def setData(self, x=None, y=None, z=None, colors=None, **kwds):
        """
        ...
        **Arguments:**
        ...
        """
        args = ('showGrid', 'lineColor', 'lineWidth', 'lineAntialias')
    ...
    def _update_grid(self):
        if not self.showGrid or self._z is None:
            return
        ...
        opts = {
            'glOptions': self.gl_line_options, 'antialias': self.lineAntialias,
