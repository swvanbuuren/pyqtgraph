...
class GLSurfacePlotItem(GLMeshItem):
    ...
    **Bases:** :class:`GLMeshItem <pyqtgraph.opengl.GLMeshItem>`
    ...
    def __init__(self, parentItem=None, **kwds):
        ...
        surface_keys = (
            'x', 'y', 'z', 'colors', 'showGrid', 'lineColor', 'lineWidth',
            'lineAntialias'
        )
        surface_kwds = {}
    ...
    def setData(self, **kwds):
        ...
        **Arguments:**
        ...
        for arg in ('showGrid', 'lineColor', 'lineWidth', 'lineAntialias'):
            if arg in kwds:
                setattr(self, '_' + arg, kwds[arg])

        x, y, z, colors = map(kwds.get, ('x', 'y', 'z', 'colors'))
    ...
    def _update_grid(self):
        ...
        opts = {
            'glOptions': self.gl_line_options, 'antialias': self._lineAntialias,
            'color': self._lineColor, 'width': self._lineWidth
        }
